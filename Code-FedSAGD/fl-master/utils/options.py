...
def args_parser():
    ...
    parser.add_argument('--beta_', type=float, default=0, help='the value of fed_localnesterov amd fednesterov')   
    parser.add_argument('--beta_0', type=float, default=0, help='the value of fed_localnesterov amd fednesterov')   
    parser.add_argument('--mu', type=float, default=0, help='the value of FedProx')
    parser.add_argument('--lammda', type=float, default=0, help='the value of FedProx')
